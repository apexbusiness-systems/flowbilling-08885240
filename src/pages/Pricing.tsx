          ...
          <Card className="relative flex flex-col border-2 border-primary shadow-xl">
            ...
            <CardHeader>
              ...
              <div className="pt-4">
                ...
                <p className="text-sm text-muted-foreground mt-2">
                  {t('pricing.includesUpTo', { count: PRICING_PLANS.GROWTH.included_invoices.toLocaleString(), defaultValue: 'Includes up to {{count}} invoices/month' })}
                </p>
                <p className="text-sm text-muted-foreground">
                  {t('pricing.perAdditional', { price: formatCurrency(PRICING_PLANS.GROWTH.overage_price_per_invoice_cents), defaultValue: '{{price}} per additional invoice' })}
                </p>
              </div>
            </CardHeader>
            <CardContent className="flex-1">
